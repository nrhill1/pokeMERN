...
class Result extends Component {
	...
	onClick = (e) => {
		...
		let pokemon = {
			...
			sprites: [this.props.pokemon.sprites['front_default'], this.props.pokemon.sprites['back_default']]
		};
				...
				<div className="result">
					...
					<Card className="resultCard" border="dark" style={{ width: '18rem' }}>
						...
						<Card.Body>
							...
							{isAuth ? (
								<Button className="addButton" variant="primary" onClick={this.onClick}>
